...
public class GhostSensorTest {
    ...
    public void testPing() {
		...
		assertEquals("1 above 0 angle",1,sensor.getPing(100,99,0,ghostList));
		assertEquals("1 Right 0 angle",1,sensor.getPing(101,100,0,ghostList));
		assertEquals("1 Left  0 angle",1,sensor.getPing(99,100,0,ghostList));

		assertEquals("1 below 90 angle",1,sensor.getPing(100,101,90,ghostList));
		assertEquals("1 above 90 angle",1,sensor.getPing(100,99,90,ghostList));
		...
		assertEquals("1 below 180 angle",1,sensor.getPing(100,101,180,ghostList));
		assertEquals("1 above 180 angle",1,sensor.getPing(100,99,180,ghostList));
		assertEquals("1 Right 180 angle",1,sensor.getPing(101,100,180,ghostList));
		assertEquals("1 Left  180 angle",1,sensor.getPing(99,100,180,ghostList));
